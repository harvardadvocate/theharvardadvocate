      ...
      <div className="horizontalContainer">
        <div className="mainContent">
              ...
              <div className="issueCover">
                <Link to={"/issues/" + itemData.slug.current}>
                  {itemData.frontCover && "asset" in itemData.frontCover && (
                    <img
                      src={optimizeImageLoading(itemData.frontCover.asset.url)}
                      alt=""
                      loading="lazy"
                    />
                  )}
          ...
          <div className="topArticles">
              ...
              <div className="articleHeader">
                <Themed.h3>
                  <i>
                    <a
                      href={
                        "sections/" + featuredArticle1.sections[0].slug.current
                      }
                    >
                      {featuredArticle1.sections[0].title}
                    </a>{" "}
                    •{" "}
                    <a href={"issues/" + featuredArticle1.issue.slug.current}>
                      {featuredArticle1.issue.title}
                    </a>
                  </i>
                </Themed.h3>
              </div>
              <a href={featuredArticle1.slug.current}>
              ...
              <div className="articleHeader">
                <Themed.h3>
                  <i>
                    <a
                      href={
                        "sections/" + featuredArticle2.sections[0].slug.current
                      }
                    >
                      {featuredArticle2.sections[0].title}
                    </a>{" "}
                    •{" "}
                    <a href={"issues/" + featuredArticle2.issue.slug.current}>
                      {featuredArticle2.issue.title}
                    </a>
                  </i>
                </Themed.h3>
              </div>
              <a href={featuredArticle2.slug.current}>
              ...
              <div className="articleHeader">
                <Themed.h3>
                  <i>
                    <a
                      href={
                        "sections/" + featuredArticle3.sections[0].slug.current
                      }
                    >
                      {featuredArticle3.sections[0].title}
                    </a>{" "}
                    •{" "}
                    <a href={"issues/" + featuredArticle3.issue.slug.current}>
                      {featuredArticle3.issue.title}
                    </a>
                  </i>
                </Themed.h3>
              </div>
              <a href={featuredArticle3.slug.current}>
            ...
            <div className="div4">
              <div className="div4image">
                <a href={featuredArticle4.slug.current}>
                  <img
                    src={optimizeImageLoading(
                      featuredArticle4.mainImage.asset.url
                    )}
                    alt="Illustration"
                    loading="lazy"
                  ></img>
                  ...
                  <Themed.h3>
                    <i>
                      <a
                        href={
                          "sections/" +
                          featuredArticle4.sections[0].slug.current
                        }
                      >
                        {featuredArticle4.sections[0].title}
                      </a>{" "}
                      •{" "}
                      <a href={"issues/" + featuredArticle4.issue.slug.current}>
                        {featuredArticle4.issue.title}
                      </a>
                    </i>
                  </Themed.h3>
                </div>
              ...
              <div className="articleHeader">
                <Themed.h3>
                  <i>
                    <a
                      href={
                        "sections/" + featuredArticle5.sections[0].slug.current
                      }
                    >
                      {featuredArticle5.sections[0].title}
                    </a>{" "}
                    •{" "}
                    <a href={"issues/" + featuredArticle5.issue.slug.current}>
                      {featuredArticle5.issue.title}
                    </a>
                  </i>
                </Themed.h3>
              </div>

              <a href={featuredArticle5.slug.current}>
              ...
              <div className="articleHeader">
                <Themed.h3>
                  <i>
                    <a
                      href={
                        "sections/" + featuredArticle6.sections[0].slug.current
                      }
                    >
                      {featuredArticle6.sections[0].title}
                    </a>{" "}
                    •{" "}
                    <a href={"issues/" + featuredArticle6.issue.slug.current}>
                      {featuredArticle6.issue.title}
                    </a>
                  </i>
                </Themed.h3>
              </div>
              <a href={featuredArticle6.slug.current}>
            ...
            <div className="div7">
              <div className="div7image">
                <a href={featuredArt1.slug.current}>
                  <img
                    src={optimizeImageLoading(featuredArt1.mainImage.asset.url)}
                    alt="Art"
                    loading="lazy"
                  ></img>
                </a>
                ...
                <div className="articleHeader">
                  <Themed.h3>
                    <i>
                      <a
                        href={
                          "sections/" + featuredArt1.sections[0].slug.current
                        }
                      >
                        {featuredArt1.sections[0].title}
                      </a>{" "}
                      •{" "}
                      <a href={"issues/" + featuredArt1.issue.slug.current}>
                        {featuredArt1.issue.title}
                      </a>
                    </i>
                  </Themed.h3>
                </div>
            ...
            <div className="div8">
              <div className="div8image">
                <a href={featuredArt2.slug.current}>
                  <img
                    src={optimizeImageLoading(featuredArt2.mainImage.asset.url)}
                    alt="Art"
                    loading="lazy"
                  ></img>
                </a>
                ...
                <div className="articleHeader">
                  <Themed.h3>
                    <i>
                      <a
                        href={
                          "sections/" + featuredArt2.sections[0].slug.current
                        }
                      >
                        {featuredArt2.sections[0].title}
                      </a>{" "}
                      •{" "}
                      <a href={"issues/" + featuredArt2.issue.slug.current}>
                        {featuredArt2.issue.title}
                      </a>
                    </i>
                  </Themed.h3>
                </div>
          ...
          <div className="sanctumSessions">
            <hr />
            <img src="/sanctum_sessions.png" loading="lazy" alt="Sanctum" />
          </div>
          <div className="blog">
            <hr />
            <Themed.h2>
            ...
            <Themed.p>
              <i>
                The fresh online pieces we experiment with outside of our print
                cycle. Or just a blog.
              </i>
            </Themed.p>
            <div className="blogGrid">
              {[featuredArticle1, featuredArticle2, featuredArticle3].map(
                (article) => {
                  return (
                    <div className="blogArticle" key={article.title}>
                      <div className="articleHeader">
                        <Themed.h3>
                          <i>
                            <a
                              href={
                                "sections/" + article.sections[0].slug.current
                              }
                            >
                              {article.sections[0].title}
                            </a>{" "}
                            •{" "}
                            <a href={"issues/" + article.issue.slug.current}>
                              {article.issue.title}
                            </a>
                          </i>
                        </Themed.h3>
                      ...
                      <a href={article.slug.current}>
                        <Themed.h2>{article.title}</Themed.h2>
                      </a>
                      <br />
                      <Link to={article.slug.current}>
          ...
          <div className="fromTheArchives">
            ...
            <div className="archivesMainGrid">
              {[
                fromTheArchivesContent.slice(0, 2),
                fromTheArchivesContent.slice(9, 11),
                fromTheArchivesContent.slice(4, 6),
              ].map((archiveSlices) => {
                return (
                  <div className="archivesCol">
                    {archiveSlices.map((archiveArticle) => {
                      return (
                        <div
                          className="archiveArticle"
                          key={archiveArticle.title}
                        >
                          <div className="articleHeader">
                            <Themed.h3>
                              <i>
                                <a
                                  href={
                                    "sections/" +
                                    archiveArticle.sections[0].slug.current
                                  }
                                >
                                  {archiveArticle.sections[0].title}
                                </a>{" "}
                                •{" "}
                                <a
                                  href={
                                    "issues/" +
                                    archiveArticle.issue.slug.current
                                  }
                                >
                                  {archiveArticle.issue.title}
                                </a>
                              </i>
                            </Themed.h3>
                          </div>
                          <a href={archiveArticle.slug.current}>
                            <Themed.h2>{archiveArticle.title}</Themed.h2>
                          </a>
                          <br />
                          ...
                          <br />
                          <Themed.h4>
                            By {archiveArticle.authors[0].name}
                          </Themed.h4>
                        </div>
                      );
                    })}
